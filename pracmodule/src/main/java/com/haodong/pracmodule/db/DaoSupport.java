...
import com.haodong.pracmodule.db.curd.QuerySupport;
    ...
    private ContentValues contentValuesByObj(T obj) {
        ...
        for (Field field : fields) {
            try {
                ...
                String key = field.getName(); // 变量名称
                // 获取value
                Object value = field.get(obj); // value
                // put 第二个参数是类型  把它转换

                mPutMethodArgs[0] = key;
                mPutMethodArgs[1] = value;

                String filedTypeName = field.getType().getName(); // 变量类型
