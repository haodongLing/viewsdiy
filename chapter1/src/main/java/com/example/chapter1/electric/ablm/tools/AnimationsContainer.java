...
//    private int resId = R.array.frame_success; //图片资源
    ...
    public  void setInstance(AnimationsContainer mInstance) {
...
//    private int[] mProgressAnimFrames = getData(resId);
     ...
     */
    public FramesSequenceAnimation createProgressDialogAnim() {
    ...
    public class FramesSequenceAnimation {
        ...
        public  void setData(ImageView imageView, int resId, int fps){
