...
public class StatusbarUtils {
     ...
     * * API等级22:Android 5.1 Lollipop  API等级23:Android 6.0 Marshmallow   API等级24:Android 7.0
     * Nougat
     *
     * @param activity
     * @param color
     * @param alpha
     */
    private static void setColor(Activity activity, int color, @IntRange(from = 0, to = 255) int
            alpha) {
